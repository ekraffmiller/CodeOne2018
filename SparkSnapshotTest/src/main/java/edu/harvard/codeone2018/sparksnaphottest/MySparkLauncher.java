 ...
 */
package edu.harvard.codeone2018.sparksnaphottest;
...
public class MySparkLauncher implements SparkAppHandle.Listener {
    ...
    public  void submit(String args[])  throws IOException, InterruptedException {
        String master = "k8s://https://192.168.99.100:8443";
         String appResource ="local:///opt/spark/jars/SparkSnapshotTest-1.0-SNAPSHOT.jar";
         String image = "registry.hub.docker.com/ellenkraffmiller/snapshot-test:latest";
         String sparkClass = "edu.harvard.codeone2018.sparksnapshottest.SimpleSparkApp";
      ...
      //   .setSparkHome("/Applications/spark-2.3.2-bin-hadoop2.7")
         ...
         .setAppName("snapshot-test")
         .setConf("spark.app.name","snapshot-test")
